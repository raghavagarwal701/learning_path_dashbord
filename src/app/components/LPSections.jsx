  ...
  const features = [
    {
      ...
      description: "Streamline lesson planning, resource management, and progress tracking, allowing tutors to focus on teaching and student success.",
      icon: <TrendingUp className="h-8 w-8 text-[#5624d0] dark:text-[#7c4dff]" />,
    },
    {
      title: "Seamless Resource Management",
      description: "Effortlessly upload, organize, and share learning materials in multiple formats—making resources easily accessible for both tutors and students.",
      icon: <Users className="h-8 w-8 text-[#5624d0] dark:text-[#7c4dff]" />,
    },
    {
      title: "Personalized Learning Paths",
      description: "Create custom learning journeys tailored to each student’s needs, with specific goals and guided progress.",
      icon: <Briefcase className="h-8 w-8 text-[#5624d0] dark:text-[#7c4dff]" />,
    },
    {
      title: "Efficient Progress Trackingt",
      description: "Utilize charts and visual reports to identify student performance trends and focus on areas needing extra support.",
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              ...
              >
                SikshaSetu - A Platform for Small Tutors
              </motion.h1>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                Empowering tutors with insights, personalized paths, and seamless resources for student success
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-12 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <Alert className="bg-red-100 dark:bg-red-900">
            <AlertTitle className="text-red-800 dark:text-red-200 text-lg font-semibold">Challenges Faced by Home Tutors</AlertTitle>
            <AlertDescription className="text-red-700 dark:text-red-300">
              <ul className="list-disc list-inside space-y-2 mt-2">
                <li>Tracking Student Progress</li>
                <li>Manging Learning Materials</li>
                <li>Creating Personalized Learning Paths</li>
                <li>Identifying Struggling Students</li>
              </ul>
            </AlertDescription>
          </Alert>
        </div>
      ...
      <section className="py-12 bg-[#f8f9fb] dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8 text-center text-[#1c1d1f] dark:text-white">
            Shiksha Setu: Your Pathway to Sucess in Education
          </h2>
